...
def main():
	sig=Lemmatizer()
	trainData,characterSet,Source_MAX_LEN_train,Target_MAX_LEN_train,chs,cht=sig.getData('./Data/en_ewt-um-train.conllu')
	testData, testCharacterSet,Source_MAX_LEN_test,Target_MAX_LEN_test,chtest,chstest=sig.getData('Data/en_ewt-um-dev.conllu',False)
